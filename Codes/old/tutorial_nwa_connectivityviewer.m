function tutorial_nwa_connectivityviewer(data, param, colorlim)
...
set(gcf,'windowbuttondownfcn',{@fancyplotting, [h1 h2 h3], data.pos, data.tri, dat, atlas})
caxis(colorlim);

function fancyplotting(hObject, ~, axh, pos, tri, dat, atlas)
