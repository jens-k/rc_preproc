...
paths.data                  = 'D:\Sleep\DataDownload\Recordings\MNight';
paths.sl_hypnograms         = 'D:\Sleep\DataDownload\Hypnograms';
paths.save                  = 'D:\Sleep\DataDownload\Preprocessing\';
...
for subj = 1:numel(files)
    ...
    cfg_trial.counter           = subj;		% to easier find the dataset again later on
...
path_prep = 'D:\Sleep\DataDownload\Preprocessing';
